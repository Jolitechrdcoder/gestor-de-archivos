...
<div class="container-fluid">
	<div class="col-lg-12">
		...
		<div class="row">
			<button class="btn btn-primary btn-sm" id="new_folder"><i class="fa fa-plus"></i> Carpeta Nueva</button>
...
<script>
	...
	$("div.custom-menu .delete").click(function(e){
		e.preventDefault()
		_conf("¿Estás segura de eliminar este archivo?",'delete_folder',[$(this).attr('data-id')])
	})
})
	...
	$("div.file.custom-menu .delete").click(function(e){
		e.preventDefault()
		_conf("c",'delete_file',[$(this).attr('data-id')])
	})
...
//FILE
	...
	function delete_folder($id){
		...
		$.ajax({
			...
			success:function(resp){
				if(resp == 1){
					alert_toast("Carpeta Borrada Con exito.",'success')
						setTimeout(function(){
							location.reload()
						},1500)
				}
